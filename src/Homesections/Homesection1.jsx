...
export default function HeroSection() {
  ...
  // ===== RIGHT PANEL VIDEO OPTIONS (SEPARATE) =====
  const rightVideoOptions = {
    trading: [
      { id: 'trading-campaign', label: 'Algorithmic Trading Growth', url: 'video/client.mp4' }
    ]
  };
  ...
  // Right panel is fixed to "trading"
  const rightVideo = rightVideoOptions.trading[0];
    ...
    <>
      ...
      <section className="relative w-full bg-gradient-to-br from-[#0f0020] via-[#1a0033] to-[#0f0f1e] pb-0 pt-20 md:pt-12 lg:pt-16">
        <div className="max-w-screen-2xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 pt-10 md:grid-cols-2 gap-6">
            ...
            <div className="relative group rounded-xl overflow-hidden h-[220px] sm:h-[300px] md:aspect-video md:h-auto shadow-2xl border border-white/10">
              ...
              <div className="absolute inset-0 flex flex-col justify-between p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="text-center text-white">
                  <h3 className="text-2xl sm:text-4xl font-bold uppercase tracking-wide mb-2 scroller-hidden">
              ...
              <div className="absolute top-2 sm:top-4 md:top-6 left-1/2 transform -translate-x-1/2 z-20 flex items-center gap-2 sm:gap-3 bg-black/60 backdrop-blur-md rounded-full px-2 sm:px-4 py-1 sm:py-2 shadow-lg max-w-[90vw]">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center overflow-hidden gap-2 px-3 py-1 bg-purple-600/95 hover:bg-purple-700 rounded-md text-white text-sm sm:text-base"
                  >
                    <span className="hidden sm:inline">{categories.find(c => c.id === leftCategory)?.label}</span>
            ...
            {/* RIGHT VIDEO PANEL — SEPARATE CONTENT (TRADING ONLY) */}
            <div className="relative group rounded-xl overflow-hidden h-[220px] sm:h-[300px] md:aspect-video md:h-auto shadow-2xl border border-white/10">
              <video
                key={rightVideo.id}
              ...
              <div className="absolute top-2 sm:top-4 md:top-6 left-1/2 transform -translate-x-1/2 z-20 flex items-center gap-2 sm:gap-3 bg-black/60 backdrop-blur-md rounded-full px-2 sm:px-4 py-1 sm:py-2 shadow-lg max-w-[90vw]">
                <h4 className="text-xs sm:text-lg md:text-2xl font-extrabold text-white truncate max-w-[120px] sm:max-w-none">
                  Our Growth Vision
                </h4>
                <div className="flex items-center gap-2 px-3 py-1 bg-purple-600/95 rounded-md text-white text-sm sm:text-base">
      ...
      <section className="relative bg-gradient-to-br from-[#0f0020] via-[#1a0033] to-[#0f0f1e] pt-12 pb-16 md:py-24">
        <div className="px-4 md:px-8 max-w-5xl mx-auto text-center">
          <h4 className="text-white text-[2.5rem] md:text-[4.5rem]">
            <i>“Results come from execution.”</i>
          </h4>
