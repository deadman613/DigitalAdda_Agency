...
function StatCard({ stat, index }) {
  ...
  return (
    <div
      ...
      className="group relative text-center p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-purple-900/30 via-purple-800/20 to-transparent backdrop-blur-sm border-2 border-purple-500/30 hover:border-purple-400/60 transition-all duration-500 hover:scale-[1.02] sm:hover:scale-105 hover:-translate-y-1 sm:hover:-translate-y-2"
    >
      {/* Glow effect */}
      ...
      <div className="relative mb-3 sm:mb-4 inline-block">
        <Icon className="relative w-8 h-8 sm:w-12 sm:h-12 mx-auto text-purple-300 group-hover:text-pink-300 transition-colors duration-300" />
      </div>

      {/* Number */}
      <h2 className="relative text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-br from-white via-purple-200 to-pink-200 mb-2 group-hover:scale-110 transition-transform duration-300">
        <span>{stat.final}</span>
      </h2>
      
      {/* Label */}
      <p className="relative text-purple-200 text-sm sm:text-base font-medium group-hover:text-white transition-colors duration-300 px-1">
        {stat.label}
      </p>
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <header className="text-center mb-12 sm:mb-16 md:mb-20 relative px-2">
          <div className="inline-block relative mb-4 sm:mb-6">
            ...
            <h3 className="text-purple-400 text-xs sm:text-sm tracking-[0.2em] sm:tracking-[0.3em] uppercase font-bold relative">
              Market Intelligence & Growth
            </h3>
          </div>
          
          <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent leading-tight mb-4 sm:mb-6">
            YOUR TRUSTED
            <br />
        ...
        {/* Stats Grid */}
        <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-10 items-start mb-12 sm:mb-16">
          {STATS.map((stat, idx) => (
        ...
        {/* Content Grid */}
        <div className="grid grid-cols-1 gap-8 sm:gap-10 mt-12 sm:mt-16">
          {/* Benefits Section */}
          <div className="space-y-6 sm:space-y-8">
            <div className="group relative p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/10 via-purple-900/20 to-transparent backdrop-blur-sm border-2 border-purple-500/30 hover:border-purple-400/50 transition-all duration-300 hover:scale-[1.02]">
              ...
              <p className="text-gray-100 text-base sm:text-lg leading-relaxed mb-6 sm:mb-8 relative px-1">
              ...
              <ul className="space-y-3 sm:space-y-5">
                {BENEFITS.map((benefit) => (
                  <li key={benefit} className="flex items-start sm:items-center gap-3 sm:gap-4 group/item">
                    <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400 group-hover/item:text-pink-400 group-hover/item:translate-x-1 transition-all duration-300 flex-shrink-0 mt-0.5" />
            ...
            <div className="group relative p-8 sm:p-10 md:p-12 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-purple-600/30 via-pink-600/20 to-blue-600/20 backdrop-blur-sm border-2 border-purple-400/50 text-center hover:scale-[1.02] sm:hover:scale-105 transition-transform duration-300">
              <div className="relative mb-4 sm:mb-6 inline-block">
                <Unlock className="relative w-14 h-14 sm:w-20 sm:h-20 mx-auto text-purple-200 group-hover:text-white transition-colors duration-300" />
              </div>
              
              <p className="relative text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-white via-purple-100 to-pink-100 bg-clip-text text-transparent leading-tight">
          ...
          <div className="group relative p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/10 via-purple-900/20 to-transparent backdrop-blur-sm border-2 border-purple-500/30 hover:border-purple-400/50 transition-all duration-300">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-6 sm:mb-8 bg-gradient-to-r from-purple-300 via-pink-300 to-blue-300 bg-clip-text text-transparent px-1">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
              {CLIENTS.map((client) => (
                <div
                  key={client}
                  className="group/logo relative bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 text-center text-xs sm:text-sm font-semibold text-white hover:from-purple-500/20 hover:to-pink-500/20 transition-all duration-300 hover:scale-[1.03] sm:hover:scale-105 hover:-translate-y-0.5 sm:hover:-translate-y-1 border border-white/10 hover:border-purple-400/50"
                >
